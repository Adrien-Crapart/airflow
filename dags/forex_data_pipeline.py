...
with DAG("forex_data_pipeline", start_date=datetime(2021, 1, 1),
    ...
    is_forex_rates_available = HttpSensor(
        ...
        poke_interval=5,  # all the 5seconds
        timeout=20
    )
    ...
    send_slack_notification = SlackWebhookOperator(
        ...
        channel="#automatic-update"
    )

    is_forex_rates_available >> is_forex_currencies_file_available >> downloading_rates >> forex_processing
